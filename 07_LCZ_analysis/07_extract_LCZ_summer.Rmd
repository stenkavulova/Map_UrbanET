...
ET_summer = raster::raster("D:/Stenka_UWI/Topic_3/05_RESULTS/20220207_summer_monthlyET/ETmonthly_summer_avg.tif")

raster::plot(ET_summer, col = colorRampPalette(c("dark red", "red3", "orange1", 'lightgoldenrod1', "seagreen1", "dodgerblue4", "blue4"))(255))

raster::crs(ET_summer)
...
ex_LCZ = exact_extract(x = ET_summer, y = LCZ_sf)

toc()

tic.clearlog()

# extract: 12.82 sec elapsed
...
LCZ_summer_ex = plyr::join_all(dfs = l_LCZ_dfs, type = "full")

# probably should append next time .... this was not efficient

glimpse(LCZ_summer_ex)

# Rows: 28,829,322
unique(LCZ_summer_ex$LCZ)
#  "0"  "2"  "4"  "5"  "6"  "8"  "9"  "11" "12" "13" "14" "16" "17"

# save 
#save(LCZ_summer_ex, file = "D:/Stenka_UWI/Topic_3/05_RESULTS/20220218_ex_LCZ_Gen/summer/LCZ_summer_ex.RData")
